...
public class CenterPanel2 extends JPanel {
	...
	public JButton btnSubtractt;
	public JButton btnMultiply;
	public JButton btnDivide;
	public JButton btnDividee;
	public JButton btnReduceP1;
	public JButton btnReduceP2;
	public JButton btnInverseOfP1;
	public JButton btnInverseOfP2;
	...
	public CenterPanel2() {
		...
		btnReduceP1 = new JButton("Reduce P1");
		...
		add(btnReduceP1);
		 ...
		 btnReduceP2 = new JButton("Reduce P2");
		...
		add(btnReduceP2);
		 ...
		 btnInverseOfP1 = new JButton("Inverse of P1");
		...
		add(btnInverseOfP1);
		 ...
		 btnInverseOfP2 = new JButton("Inverse of P2");
		...
		btnSubtractt = new JButton("P2 - P1");
		...
		add(btnSubtractt);
		 ...
		 btnMultiply = new JButton("P1 x P2");
